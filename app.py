...
(function(){
  ...
  var metas = [
    ...
    ['apple-mobile-web-app-title','Jurídica'],
...
st.markdown(f"""<div class="main-header" style="display:flex;align-items:center;gap:20px;">
  ...
  <div>
    <div style='font-size:9px;letter-spacing:3px;color:#bee3f8;font-weight:600;'>LOVATO &amp; ESTEVÃO · ADVOCACIA</div>
